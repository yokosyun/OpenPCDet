...
def main():
    ...
    config = {
        ...
        "algorithm": "max",  # ["max", "smoothquant", "awq_lite", "awq_clip", "awq_full", "real_quantize"]
    }

    model = apply_mode(
        model, mode=[("quantize", config)], registry=QuantizeModeRegistry
    )
    ...
    demo_dataset = DemoDataset(
        ...
        class_names=cfg.CLASS_NAMES,
        training=False,
        root_path=Path("../data/kitti/training/velodyne/000008.bin"),
        ext=".bin",
        logger=logger,
    )
